...
export const NotificationItem = () => {
    return (
        <>
            <Menu
                menuButton={
                    <MenuButton className="relative hover:bg-primary-200 p-2 rounded-lg transition-colors duration-300">
                        <RiNotification3Line />
            ...
            >
                ...
                <MenuItem className="p-0 hover:bg-transparent flex justify-center cursor-default">
                    <Link to="/" className="text-gray-400 text-sm hover:text-white transition-colors duration-300">Leer todas las notificaciones.</Link>
                </MenuItem>
            </Menu>
        </>
    )
